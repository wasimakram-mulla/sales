...
stockmgmt.controller("AddClientProductController", function($scope, $http){	
	$scope.getProdId = function(){
		$(".prodname").attr("disabled","disabled");
		$http({
				method: 'POST',
				url: 'php/master.php?action=getClientProdId',
				headers: {'Content-Type': 'application/x-www-form-urlencoded'},			
			}).
				success(function(data, status, headers, config) {
			}).
	...
	$http({
			method: 'POST',
			url: 'php/master.php?action=AddClientProduct',
			headers: {'Content-Type': 'application/x-www-form-urlencoded'},
			data: mainObj
		}).
			success(function(data, status, headers, config) {
...
stockmgmt.controller("ClientProductListController", function($scope, $http, $route){
	$scope.initCalls = function(){
		$(".noData").hide();
		$(".fullData").hide();
		$(".loadData").show();
	...
	$scope.deleteproduct = function(pid){
		$http({
			method: 'POST',
			url: 'php/master.php?action=deleteclientproduct',
			headers: {'Content-Type': 'application/x-www-form-urlencoded'},
			data:pid
		}).
			success(function(data, status, headers, config) {
	...
	$scope.editProductDetails = function(ProductId){
		...
		$http({
			method: 'POST',
			url: 'php/master.php?action=SpecificClientProductDetails',
			headers: {'Content-Type': 'application/x-www-form-urlencoded'},
			data:ProductId
		}).
			success(function(data, status, headers, config) {
	...
	$scope.saveEdittedProductDetails = function(){		
		...
		$http({
			method: 'POST',
			url: 'php/master.php?action=UpdateClientProductDetails',
			headers: {'Content-Type': 'application/x-www-form-urlencoded'},
			data: mainObj
		}).
			success(function(data, status, headers, config) {
